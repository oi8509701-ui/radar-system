...
# -*- coding: utf-8 -*-
"""
AUTOMATED Gerber Export Script
"""
...
def export_gerbers():
    ...
    if not KICAD_AVAILABLE:
        ...
        # Create standalone Gerber export script
...
'''
        ...
        script_path = "/Users/mac/PLFM_RADAR_NEWS/MainBoard/RADAR_Main_Board/export_gerbers.py"
        with open(script_path, 'w') as f:
            f.write(script)
        
        print(f"✅ Script created: {script_path}")
        print("   Run with: python3 export_gerbers.py")
        return False
